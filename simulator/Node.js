...
simsNS.Node = function(xOrModel, yOrXml, model)
{
    if(typeof xOrModel === "Model" && typeof yOrXml != undefined)
    {
        //we have one model param
        this.model = model;
    }
    else if(typeof xOrModel === "Model")
    {
        //we have two model param, xml param
        ...
        {
            this.PositionX = parseFloat(yOrXml.X);   double.Parse(xml.ReadContentAsString());

        }
        if (xml.MoveToAttribute("Y".ToLower()))
        {
            this.PositionY = parseFloat(yOrXml.Y);
...
simsNS.Node.prototype.model = null;
simsNS.Node.prototype.positionX = null;
simsNS.Node.prototype.positionY = null;
simsNS.Node.prototype.velocityX = null;
simsNS.Node.prototype.velocityY = null;
simsNS.Node.prototype.id = null;
simsNS.Node.prototype.fx = null;
simsNS.Node.prototype.fy = null;

simsNS.Node.prototype.calculateForce = function()
{
    this.Fx = 0;
    this.Fy = 0;
}
